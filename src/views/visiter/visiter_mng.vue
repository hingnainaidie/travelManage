		...
		<el-container style="padding: 0px; margin: 0px;">
			<el-header style="height: 60px; padding: 0px; margin: 0px;">
				<div class='appicon'>
					...
					<div class="topMenu">
						<el-menu :default-active="this.$router.path" class="el-menu-demo" mode="horizontal"
							background-color="#545c64" text-color="#fff" active-text-color="#ffd04b"
							@select="handleSelect">
							<el-menu-item index="/visiter_mng/visiter_leader">
		...
		data() {
			return {
				...
				userInfo: {
					...
					scenicId: window.localStorage.getItem.scenicId,
					scenicName: window.localStorage.getItem.scenicName,
					userName: window.localStorage.getItem.userName,
					userGender: window.localStorage.getItem.userGender,
					userIdentify: window.localStorage.getItem.userIdentifyuserLeveluserLevel,
					userLevel: window.localStorage.getItem.userLeveluserLevel,
					userPhoneuserPhone: window.localStorage.getItem.userPhone,
